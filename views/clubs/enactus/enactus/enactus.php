...
<body>
    ...
    <main class="container mt-5">
        <section>
            <h1 class="text-center">Enactus</h1>
            <p class="text-muted">Date de création : 12/11/2019</p>
            <p>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card text-center">
                        <img src="enactusmembre1.jpg" class="card-img-top" alt="Membre 1">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <img src="enactusmembre2.jpg" class="card-img-top" alt="Membre 2">
                        <div class="card-body">
            ...
            <div id="clubCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="enactus1" class="d-block w-100" alt="Photo du club 1">
                    </div>
                    <div class="carousel-item">
                        <img src="enactus2" class="d-block w-100" alt="Photo du club 2">
                    </div>
                    <div class="carousel-item">
                        <img src="enactus3" class="d-block w-100" alt="Photo du club 3">
                    </div>
        ...
        <section class="mt-5">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="enacev" class="card-img-top" alt="Événement 1">
                        <div class="card-body">
