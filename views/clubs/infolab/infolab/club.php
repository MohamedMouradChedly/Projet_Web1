...
<body>
    ...
    <main class="container mt-5">
        <section>
            <h1 class="text-center">Infolab</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card text-center">
                        <img src="essectmembre1.jpg" class="card-img-top" alt="Membre 1">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <img src="essectmembre2.jpg" class="card-img-top" alt="Membre 2">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <img src="essectmembre3.jpg" class="card-img-top" alt="Membre 3">
                        <div class="card-body">
                            <h5 class="card-title">Membre 3</h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="clubCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="infolab1.jpg" class="d-block w-100" alt="Photo du club 1">
                    </div>
                    <div class="carousel-item">
                        <img src="infolab2.jpg" class="d-block w-100" alt="Photo du club 2">
                    </div>
                    <div class="carousel-item">
                        <img src="infolab3.jpg" class="d-block w-100" alt="Photo du club 3">
                    </div>
                    <div class="carousel-item">
                        <img src="infolab4.jpg" class="d-block w-100" alt="Photo du club 4">
                    </div>
                </div>
        ...
        <section class="mt-5">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="even1.jpg" class="card-img-top" alt="Événement 1">
                        <div class="card-body">
                            <h5 class="card-title">Reussir mon PFE</h5>
                            <p class="card-text">Learn everything you need to succeed in your PFE.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="even2.jpg" class="card-img-top" alt="Événement 2">
                        <div class="card-body">
                            <h5 class="card-title">Conférence LinkedIn</h5>
                            <p class="card-text">Boostez votre profil et developpez votre reseau professionnel.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="even3.jpg" class="card-img-top" alt="Événement 3">
                        <div class="card-body">
                            <h5 class="card-title">Google</h5>
                            <p class="card-text">Venez decouvrer le potentiel de Google.</p>
                        </div>
                    </div>
                </div>
            </div>
